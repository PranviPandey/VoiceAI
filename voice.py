...
def execute(command):
    ...
    #     execute_calender()
        ...
        command_info = {
                    "search on YouTube": "Searches YouTube for your query.",
                    "play/pause video": "Plays or pauses the current YouTube video.",
                    "scroll up/down": "Scrolls the web page up or down.",
                    "go back": "Navigates to the previous page.",
                    "search on Google": "Performs a Google search for your query.",
                    "copy URL": "Copies the URL of the webpage.",
                    "download file": "Finds and downloads a file in WhatsApp Web.",
                    "read file": "Reads aloud the latest downloaded file (PDF, DOCX, TXT).",
                    "sleep/wake": "Puts the assistant to sleep or wakes it up.",
                    "info": "Explains available commands and their usage.",
                    "exit/stop": "Exits the current command"
                }
        speak("Here are the available commands you can use:")
...
#     speak("Voice assistant ready. you can say info to know the available commands.")
#     while True:
#         speak("What can i do for you?")
#         cmd = listen()
...
def run_voice_assistant():
    speak("Voice command ready. Say something...")
    while True:
        speak("What can i do for you?")
        cmd = listen()
        execute(cmd)
